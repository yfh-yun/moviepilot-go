...
// Create 创建站点用户数据
func (r *SiteUserDataRepositoryImpl) Create(ctx context.Context, userData *models.SiteUserData) error {
	return r.db.WithContext(ctx).Create(userData).Error
}

// GetByID 根据ID获取站点用户数据
func (r *SiteUserDataRepositoryImpl) GetByID(ctx context.Context, id string) (*models.SiteUserData, error) {
	var userData models.SiteUserData
...
func (r *SiteUserDataRepositoryImpl) GetByUserID(ctx context.Context, userID string) ([]*models.SiteUserData, error) {
	var userDataList []*models.SiteUserData
	err := r.db.WithContext(ctx).Where("user_id = ?", userID).Find(&userDataList).Error
	return userDataList, err
}

// GetBySiteID 根据站点ID获取用户数据
func (r *SiteUserDataRepositoryImpl) GetBySiteID(ctx context.Context, siteID string) ([]*models.SiteUserData, error) {
	var userDataList []*models.SiteUserData
...
func (r *SiteUserDataRepositoryImpl) GetByUserAndSite(ctx context.Context, userID, siteID string) (*models.SiteUserData, error) {
	var userData models.SiteUserData
...
// Update 更新站点用户数据
func (r *SiteUserDataRepositoryImpl) Update(ctx context.Context, userData *models.SiteUserData) error {
...
func (r *SiteUserDataRepositoryImpl) Delete(ctx context.Context, id string) error {
	return r.db.WithContext(ctx).Delete(&models.SiteUserData{}, "id = ?", id).Error
}

// List 获取站点用户数据列表
func (r *SiteUserDataRepositoryImpl) List(ctx context.Context, params interfaces.ListSiteUserDataParams) ([]*models.SiteUserData, int64, error) {
	var userDataList []*models.SiteUserData
	var total int64
	
	query := r.db.WithContext(ctx).Model(&models.SiteUserData{})
