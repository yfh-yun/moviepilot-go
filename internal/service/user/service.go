...
type Service interface {
	...
	ListUsers(ctx context.Context, params interfaces.ListUserParams) ([]*models.User, int64, error)
...
func (s *service) ListUsers(ctx context.Context, params interfaces.ListUserParams) ([]*models.User, int64, error) {
	log := logger.WithContext(ctx)
