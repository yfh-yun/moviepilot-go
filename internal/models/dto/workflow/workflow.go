...
import (
	...
	"moviepilot-go/internal/models/dto/download"
	"moviepilot-go/internal/models/dto/file"
	"moviepilot-go/internal/models/dto/site"
	"moviepilot-go/internal/models/dto/subscribe"
)
...
type ActionContext struct {
	...
	// 资源列表
	Torrents []*dto.Context `json:"torrents,omitempty"`
	// 媒体列表
	Medias []*dto.MediaInfo `json:"medias,omitempty"`
	// 文件列表
	FileItems []*file.FileItem `json:"fileitems,omitempty"`
	// 下载任务列表
	Downloads []*download.DownloadTask `json:"downloads,omitempty"`
	// 站点列表
	Sites []*site.Site `json:"sites,omitempty"`
	// 订阅列表
	Subscribes []*subscribe.Subscribe `json:"subscribes,omitempty"`
	// 执行历史
