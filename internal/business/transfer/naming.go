...
// GeneratePath 生成目标路径
func (s *TemplateNamingStrategy) GeneratePath(media *models.Media, sourcePath string, metadata FileMetadata) (string, error) {
	// 从 Media 模型获取基础变量
...
func (m *NamingManager) GeneratePath(media *models.Media, sourcePath string, metadata FileMetadata) (string, error) {
