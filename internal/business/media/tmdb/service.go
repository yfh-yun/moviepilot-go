...
func (s *SimpleTMDBService) makeRequest(ctx context.Context, endpoint string, result interface{}) error {
	if s.apiKey == "" {
...
func (s *SimpleTMDBService) makeCachedRequest(ctx context.Context, endpoint string, result interface{}, cacheTTL time.Duration) error {
	// 检查缓存
