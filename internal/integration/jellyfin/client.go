...
func (c *Client) HealthCheck(ctx context.Context) error {
	...
	if resp.StatusCode != http.StatusOK {
		return fmt.Errorf("Jellyfin服务器健康检查失败，状态码: %d", resp.StatusCode)
	}

	c.logger.Debug("Jellyfin服务器健康检查成功")
	return nil
}
...
func (c *Client) GetServerInfo(ctx context.Context) (*MediaServerInfo, error) {
	...
	c.logger.Debug("获取Jellyfin服务器信息成功", zap.String("server", serverInfo.Name))
...
func (c *Client) GetUsers(ctx context.Context) ([]UserInfo, error) {
	...
	c.logger.Debug("获取Jellyfin用户列表成功", zap.Int("count", len(users)))
	return users, nil
}
...
func (c *Client) GetLibraries(ctx context.Context) ([]LibraryInfo, error) {
	...
	c.logger.Debug("获取Jellyfin媒体库列表成功", zap.Int("count", len(libraries)))
...
func (c *Client) GetLibraryItems(ctx context.Context, libraryID string, params map[string]string) ([]MediaItem, error) {
	...
	c.logger.Debug("获取Jellyfin媒体库项目成功",
...
func (c *Client) RefreshLibrary(ctx context.Context, libraryID string) error {
	...
	c.logger.Info("刷新Jellyfin媒体库成功", zap.String("library", libraryID))
	return nil
}
...
func (c *Client) GetPlaybackSessions(ctx context.Context) ([]PlaybackInfo, error) {
	...
	c.logger.Debug("获取Jellyfin播放会话成功", zap.Int("count", len(sessions)))
	return sessions, nil
}
